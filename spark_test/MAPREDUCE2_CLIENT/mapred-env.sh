...
export HADOOP_JOB_HISTORYSERVER_OPTS="-Djava.security.auth.login.config=/etc/hadoop/2.6.1.0-129/0/mapred_jaas.conf  -Djavax.security.auth.useSubjectCredsOnly=false"
